...
##### Python code for May and Gaudet (2025), *Surface delivery quantification reveals distinct trafficking efficiencies among clustered protocadherin isoforms*. These data are also available on [Zenodo](https://doi.org/10.5281/zenodo.15941408).

***

### File descriptions

- Raw microscopy data files are available on [Zenodo](https://doi.org/10.5281/zenodo.15941408).
...
- the `calc_metrics` folder contains `.csv` files with the calculated surface delivery metrics for the experiments from the manuscript, as well as p-values for each figure calculated using Tukey's post-hoc test. These data are also available on [Zenodo](https://doi.org/10.5281/zenodo.15941408).

##### in the `Flow Cytometry for GitHub` folder:
- There are .csv files and .ipynb files associated with processing flow cytometry data. Raw .fcs files for flow cytometry data are avilable on [Zenodo](https://doi.org/10.5281/zenodo.15941408).
